...
class _TripsDataListState extends State<TripsDataList> {
  ...
  String formatDate(String dateTime) {
    try {
      ...
      return dateTime; // Trả về nguyên bản nếu không thể định dạng
    }
  }

  // Hàm chuyển đổi từ USD sang VND và định dạng
  String convertToVND(double usd) {
    const double exchangeRate = 24000; // Tỷ giá 1 USD = 23,500 VND
                ...
                children: [
                  ...
                  cMethods.data(
                    ...
                    Text(convertToVND(double.tryParse(
                            itemsList[index]["fareAmount"].toString()) ??
                        0.0)),
                  ),
                  cMethods.data(
                    1,
